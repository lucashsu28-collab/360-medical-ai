...
export const metadata: Metadata = {
  ...
  description: "同時比較多家醫美診所的五維度評分，快速找出最適合您的診所。",
};
    ...
    <div className="min-h-screen bg-[var(--paper)]">
      <div className="mx-auto max-w-[1060px] px-4 py-8 md:px-8">
        <div className="mb-8 text-center">
          ...
          <p className="text-[var(--muted)] text-sm">同時比較多家診所五維度評分，找出最值得信賴的醫美診所</p>
        </div>
        <div className="rounded-[14px] border border-[var(--line)] bg-white p-8 text-center">
          ...
          <p className="text-[13px] text-[var(--muted)]">您可以先到診所列表頁查看各診所的五維度評分</p>
        </div>
      </div>
    </div>
  );
