...
const RHYTHM_CARDS = [
  ...
  { key: "detailed", label: "詳細完整", sub: "多段落", example: "根據我們的六維度評鑑系統，這家診所各項表現如下：\n\n合法登記：18/20（衛福部查詢正常）\nGoogle 評分：16/20（4.7星，521則評論）\n司法紀錄：20/20（無任何裁判書紀錄）\n\n綜合來看，這是台北信義區品質相對穩定的選擇，特別適合第一次接觸醫美的朋友。" },
];
      ...
      <SectionCard title="⑨ 對話效果預覽">
        <div style={{ background: "#1A202C", borderRadius: 12, padding: 20 }}>
          ...
          <ChatBubble role="ai" text={
            tone === "formal"
              ? "建議您透過我們的評鑑系統，依合法登記、司法紀錄、Google評分三個維度評估。請告知您所在地區以利提供建議。"
              : tone === "concise"
