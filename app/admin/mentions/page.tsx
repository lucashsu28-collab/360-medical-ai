...
export default function MentionsPage() {
  ...
  async function runCrawler() {
    if (!confirm(`啟動媒體口碑爬蟲？將消耗 Gemini API 額度（估 $5-15 USD）`)) return;
    setRunning(true);
  ...
  return (
    <div>
      ...
      <div style={{ background: "#fff", padding: 16, borderRadius: 10, marginBottom: 12, border: "1px solid #E2E8F0", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <div style={{ fontSize: 14, fontWeight: 600 }}>📰 媒體口碑爬蟲</div>
          <div style={{ fontSize: 12, color: "#718096", marginTop: 2 }}>Google News 8 組醫美關鍵字 + Gemini 情緒/業配判定</div>
        </div>
