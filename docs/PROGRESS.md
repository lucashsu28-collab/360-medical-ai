...
| # | 項目 | 狀態 |
|---|---|---|
| P1-1 | 衛福部行政處分爬蟲（診所第4維度）（→ P4上線後優化） | ⏸️P4優化 |
| P1-2 | 診所↔醫師對應（暫緩 → 改列P3-4，改由診所自填） | ⏸️暫緩→P3 |
| P1-3 | 正式網域購買+綁定（→ P4上線後優化） | ⏸️P4優化 |
...
| #6 | 合作診所開通/停用 | `/admin/clinics/partners` | ✅完成 | ✅完成 | ❌未開始 |
...
| #13 | 告警系統 | `/admin/alerts` | ✅完成 | ✅完成 | ❌未開始 |
