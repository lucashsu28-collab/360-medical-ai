...
const phase2Modules = [
  ...
  { num:"B9", name:"衛福部ODS+NHI診所資料整合（清除非醫美259筆、補入124筆，DB總計1554筆）", status:"done",
    items:["下載衛福部醫事司ODS（24,138筆全台開業機構）","篩選整形外科+皮膚科+名稱關鍵字匯入784筆新診所","Google Places API補齊全部1688筆評分資料","精準清除：黑名單科別（牙科/中醫/耳鼻喉等）且無醫美關鍵字 → 刪除259筆","ODS名稱關鍵字二次掃描補入124筆西醫一般科醫美診所","DB最終：1554筆純醫美相關診所"] },
];
